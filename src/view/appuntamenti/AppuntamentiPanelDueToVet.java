...
public class AppuntamentiPanelDueToVet extends JPanel {
	...
	public AppuntamentiPanelDueToVet() {
		...
		costoText.setBounds(1096, 297, 100, 25);
		add(costoText);

		noteText = new JTextField();
		noteText.setBounds(1096, 339, 100, 25);
		add(noteText);
		...
		costoLabel.setBounds(964, 303, 70, 15);
		add(costoLabel);

		noteLabel = new JLabel("Note");
		noteLabel.setBounds(964, 345, 70, 15);
		add(noteLabel);

		tab = new TabellaAppuntamentiPanel(scrollPane);

		btnAggiungi = new JButton("Aggiungi");
		btnAggiungi.setBounds(964, 398, 100, 25);
		add(btnAggiungi);

		btnElimina = new JButton("Elimina");
		btnElimina.setBounds(1096, 398, 100, 25);
		add(btnElimina);

		btnModifica = new JButton("Modifica");
		btnModifica.setBounds(964, 445, 100, 25);
		add(btnModifica);

		btnAggiorna = new JButton("Aggiorna");
		btnAggiorna.setBounds(1096, 445, 100, 25);
		add(btnAggiorna);
